...
export const HeroSection = ({ onButtonClick }: ChildProps) => {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center">
      ...
      <h1 className="z-10 mt-1 text-3xl sm:text-4xl md:text-7xl lg:text-8xl font-black tracking-tight">
        <EncryptedText
      ...
      <motion.p className="z-10 mt-1 md:mt-5 w-[70%] md:w-1/2 text-xs md:text-lg text-justify [text-align-last:center] md:text-center text-white/50 tracking-tight">
      ...
      <motion.button
        ...
        className="z-10 mt-40 md:mt-20 bg-transparent text-sm sm:text-lg font-black px-4 md:px-6 py-2 md:py-3 rounded-3xl border-2 border-[#155dfc] hover:bg-neutral-900 cursor-pointer"
      >
        Let's Connect
      </motion.button>
    </div>
